...
You can file new issues by filling out our https://github.com/BlackBeltTechnology/judo-jsl-fullstack-karaf-project-template/issues/new/choose[issue form].
